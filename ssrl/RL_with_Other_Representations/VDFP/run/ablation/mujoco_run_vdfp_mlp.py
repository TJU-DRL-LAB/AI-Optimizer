...
from networks.vdfp_mlp import VDFP
...
vdfp = VDFP(s_dim, a_dim, sess, gamma=0.99,
            ...
            m_batch_size=64,
            lr_p=0.001, lr_r=0.0005, lr_a=0.00025,
            m_dim=100, z_dim=50,
            memory_size=100000)
...
if IS_SAVE_LOG:
    ...
    writer = tf.summary.FileWriter('./tf_logs/' + env_name
                                   + '/vdfp_mlp/m100k_b6464_m100_z50_gamma99_lr00025x42_tg1050_'
