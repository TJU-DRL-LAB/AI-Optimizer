"""
    run VDFP in MuJoCo tasks under delay reward settings
...
from networks.vdfp import VDFP
...
parser.add_argument("--gpu_no", type=str, default='-1', help='cuda_device')
...
if IS_SAVE_LOG:
    ...
    writer = tf.summary.FileWriter('./tf_logs/' + env + 'delayed' + str(delay_step)
                                   + '/vdfp/m100k_b6464_m100_z50_gamma99_lr00025x42_tg1050_'
