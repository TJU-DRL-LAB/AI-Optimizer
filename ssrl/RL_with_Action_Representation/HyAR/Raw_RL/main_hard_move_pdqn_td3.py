...
def run(args):
    ...
    dir = "result/PDQN/simple_move_4_direction_v1"
    data = "0815"
    ...
    title2 = "Reward_100_pdqn_td3_simple_move_4_direction_v1_" +"{}".format(args.action_n_dim)+"_"
    title3 = "Test_success_pdqn_td3_simple_move_4_direction_v1_" +"{}".format(args.action_n_dim)+"_"
    title4 = "Test_epioside_step_pdqn_td3_simple_move_4_direction_v1_" +"{}".format(args.action_n_dim)+"_"
