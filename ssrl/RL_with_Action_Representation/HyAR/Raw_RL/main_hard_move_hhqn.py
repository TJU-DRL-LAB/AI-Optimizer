...
def run(args):
    ...
    title2 = "Reward_100_hhqn_simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)+"_"
    title3 = "Test_Reward_hhqn_simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)+"_"
    title4 = "Test_success_hhqn_simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)+"_"
    title5 = "Test_epioside_step_hhqn_simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)+"_"
