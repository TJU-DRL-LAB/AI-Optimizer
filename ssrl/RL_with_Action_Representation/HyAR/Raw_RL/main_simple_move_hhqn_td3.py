...
def run(args):
    ...
    title2 = "Reward_100_hhqn_td3_simple_move_"
    title3 = "Test_Reward_hhqn_td3_simple_move_"
    title4 = "Test_success_hhqn_td3_simple_move_"
    title5 = "Test_epioside_step_hhqn_td3_simple_move_"
