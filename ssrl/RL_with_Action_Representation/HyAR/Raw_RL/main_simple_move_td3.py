...
def run(args):
    ...
    if not os.path.exists(redir):
        os.mkdir(redir)
    print("redir", redir)
    title1 = "Reward_td3_simple_move_"
    title2 = "Reward_100_td3_simple_move_"
    title3 = "Test_Reward_td3_simple_move_"
    title4 = "Test_success_td3_simple_move_"
    title5 = "Test_epioside_step_td3_simple_move_"
