...
def run(args):
    ...
    title2 = "Reward_100_hhqn_direction_catch_"
    title3 = "Test_Reward_hhqn_direction_catch_"
    title4 = "Test_success_hhqn_direction_catch_"
    title5 = "Test_epioside_step_hhqn_direction_catch_"
