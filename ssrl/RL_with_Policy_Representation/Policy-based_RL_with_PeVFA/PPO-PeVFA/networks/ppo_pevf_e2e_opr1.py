...
class PPO_PEVF(object):
    def __init__(self, s_dim, a_dim, sess,
        ...
        self.surface_pr = self._build_opr_encoder(self.param_ph)
        ...
        if self.prev_type == 0:
            ...
            self.prev_v = self._build_value_net_dense(self.s_ph, self.surface_pr, scope='PREV', trainable=True)
        ...
        print('-- INFO: PPO PEVF e2e w/ OPR initialized.')
        print('==========================')
    ...
    def _build_opr_encoder(self, params, reuse=False):
