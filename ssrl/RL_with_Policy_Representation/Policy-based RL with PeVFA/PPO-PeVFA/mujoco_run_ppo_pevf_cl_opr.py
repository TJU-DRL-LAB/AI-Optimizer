...
from networks.ppo_pevf_cl_opr import PPO_PEVF
import scipy.signal
...
def main(args):
    ...
    cur_policy = PPO_PEVF(s_dim=s_dim, a_dim=a_dim, pr_dim=pr_dim, sess=sess,
                          ...
                          mask_rate=args.cl_mask_rate, cl_tau=args.cl_tau,
                          pr_model=None)
    ...
    if is_save_data:
        print('=========================')
        print('- Saving data.')
        save_folder_path = './evaluation_data/ppo_pevf_cl_opr' + '_pf' + str(args.update_freq) \
        ...
        file_index = save_folder_path + env_name \
                     ...
                     + '_cllr' + str(args.lr_cl) + '_mr' + str(args.cl_mask_rate) \
...
def get_args_from_parser():
    ...
    parser.add_argument("--lr-cl", type=float, default=0.001, help='learning_rate_of_CL')
    ...
    parser.add_argument("--cl-mask-rate", type=float, default=0.1, help='mask_ratio_for_data_augmentation')
