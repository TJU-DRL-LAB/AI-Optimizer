...
def run(args):
    ...
    title2 = "Reward_100_ddpg_direction_catch_"
    title3 = "Test_Reward_ddpg_direction_catch_"
    title4 = "Test_success_ddpg_direction_catch_"
    title5 = "Test_epioside_step_ddpg_direction_catch_"
