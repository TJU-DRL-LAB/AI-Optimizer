...
def run(args):
    ...
    while total_timesteps < args.max_timesteps:
        ...
        for j in range(max_steps):
            ...
            if total_timesteps % args.eval_freq == 0:
                ...
                Test_Reward, Test_epioside_step, Test_success = evaluate(env, policy, action_parameter_sizes,
                                                                         episodes=100)
                print(
        ...
        # if (i + 1) % 100 == 0:
        #     Test_Reward, Test_epioside_step, Test_success = evaluate(env, policy, action_parameter_sizes, episodes=100)
        #     print('{0:5s} R:{1:.5f} P(S):{2:.4f} r100:{3:.4f} epioside_steps_100:{4:.4f}'.format(str(i + 1),
        #                                                                                          total_reward / (i + 1),
        #                                                                                          Test_success,
        #                                                                                          Test_Reward,
        #                                                                                          Test_epioside_step))
    ...
    title2 = "Reward_100_hppo_goal_"
    title3 = "success_100_hppo_goal_"
    title4 = "epioside_steps_100_hppo_goal_"
