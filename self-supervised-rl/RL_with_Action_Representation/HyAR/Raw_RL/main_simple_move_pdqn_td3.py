...
def run(args):
    ...
    title2 = "Reward_100_pdqn_td3_simple_move_4_direction_"
    title3 = "Test_success_pdqn_td3_simple_move_4_direction_"
    title4 = "Test_epioside_step_pdqn_td3_simple_move_4_direction_"
