"""
    run DDPG in MuJoCo tasks under delay reward settings
...
parser.add_argument("--ti", type=int, default=1, help='train_interval(1_or_2)')
...
while global_step_count < MAX_TOTAL_STEPS:
    ...
    for j in range(MAX_EP_STEPS):
        ...
        ddpg.store_transition(s.tolist(), a.tolist(), r_exp, l_s_, 1 - done)
